...
def main():
    ...
    # Initialize arm client for gestures
    arm_client = G1ArmActionClient()
    arm_client.SetTimeout(10.0)
    arm_client.Init()
    print("✓ ArmActionClient initialized\n")
    ...
    try:
        ...
        # # Test movement
        # print("\nTest 3: Walk forward and wave (LocoClient.WaveHand)")
        # print("Note: LocoClient.WaveHand() only works while walking!")
        # client.Move(0.2, 0, 0)  # Start walking
        # time.sleep(1)
        # client.WaveHand()  # Wave while walking
        # time.sleep(5)
        # client.StopMove()
